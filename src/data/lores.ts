...
export const lores: LoreItem[] = [
  ...
  },
  {
    ...
    message: `You have obtained <strong>Kolift's Scale</strong>. You currently can't do anything with it however in the future it will be a reuqest item.`,
  },
  {
    category: 'drop',
    key: 'kolifts-scale',
    message: `YOU HAVE REACHED THE LATEST WORK IN PROGRESS DEVELOPMENT IN THIS VERSION, THANK YOU FOR PLAYING!`,
  },
]
